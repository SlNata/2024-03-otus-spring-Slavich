...
public class BookControllerTest {
    ...
    @DisplayName("Должен вернуть ошибку для пользователя - user при редактировании книги")
    @Test
    void ShouldReturnErrorForUserUpdateBook() throws Exception {
        Book updateBook = new Book(1L, "edit book", new Author(1L, "author1"), new Genre(1L, "genre1"));
        given(bookService.findById(1)).willReturn(Optional.of(updateBook));
    ...
    @DisplayName("Должен вернуть ошибку для пользователя - user при создании книги")
    @Test
    public void shouldReturnErrorForUserInsertBook() throws Exception {
    ...
    @Test
    public void shouldReturnErrorForUserDeleteBookById() throws Exception {
        mockMvc.perform(post("/delete?id=1"))
                .andExpect(status().is4xxClientError());
    }
}
