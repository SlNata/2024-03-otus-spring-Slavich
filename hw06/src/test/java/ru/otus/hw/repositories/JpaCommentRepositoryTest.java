...
public class JpaCommentRepositoryTest {
    ...
    void shouldReturnCorrectCommentById() {
        Optional<Comment> optionalComment = jpaCommentRepository.findById(1L);
    ...
    void shouldReturnCorrectCommentsList() {
        List<Comment> listComment = jpaCommentRepository.findAllByBookId(3L);
    ...
    void shouldDeleteComment() {
        ...
        jpaCommentRepository.deleteById(2L);
