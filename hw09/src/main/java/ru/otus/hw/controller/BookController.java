...
public class BookController {
    ...
    @PostMapping("/edit")
    public String editBook(@ModelAttribute("updateBook") BookUpdateDto updateBook,
                           BindingResult bindingResult, Model model) {
        if (bindingResult.hasErrors()) {
            return "editbook";
        }
        bookService.update(updateBook.getId(),
                updateBook.getTitle(),
                updateBook.getAuthorId(),
                updateBook.getGenreId());
        return "redirect:/";
    }
    ...
    @PostMapping("/insert")
    public String insertNewBook(@Valid @ModelAttribute("updateBook") BookUpdateDto updateBook,
        ...
        bookService.insert(updateBook.getTitle(), updateBook.getAuthorId(), updateBook.getGenreId());
        return "redirect:/";
    }
